...
//let's pass in the value to both cb functions and store the relative result in a variable.    
    let res1 = cb1(value);
    let res2 = cb2(value);
// set a condition to check if the first result is grater then the second and return it in case it is.
    if(res1 > res2) {
        return res1;
